...
export default function Path() {
    ...
    return <path stop={stop} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} d={stopAnimation.current ? spline(circle,1 ,true) : spline(renderedPoints, 1, true)} className={stopAnimation.current ? "service-ball-path selected": "service-ball-path"} />;
}
